...
import { useAuth } from "../utils/Auth"; // <-- custom hook from Auth.ts
...
const ResourceCard: React.FC<ResourceCardProps> = ({ resource }) => {
  ...
  const [saveResource, { loading: saveLoading, error: saveError }] =
    useMutation(SAVE_RESOURCE);
  const [deleteResource, { loading: deleteLoading, error: deleteError }] =
